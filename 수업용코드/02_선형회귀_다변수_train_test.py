...
print("[실습] 학습용을 20대만 써서 학습하면?")
w20, b20 = 학습(Z_train[:20], y_train[:20], epochs=2000)
print(
    f"    학습용 20대 R² {R2(y_train[:20], 예측(Z_train[:20], w20, b20)):.4f} "  # ← 만점. 5대를 통째로 외웠다"
)
print(f"    시험용 60대 R² {R2(y_test, 예측(Z_test, w20, b20)):.4f} ")
print("    가중치도 달라짐:", w20.round(2), "← 140대 때는", w.round(2))
